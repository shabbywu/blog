import{_ as o,r as a,o as l,c as u,h as n,i as e,g as i,e as s}from"./app-BtInbfcg.js";const d={},r=s(`<h2 id="背景介绍" tabindex="-1"><a class="header-anchor" href="#背景介绍"><span>背景介绍</span></a></h2><p>最近在开发 K8s Operator 时遇到一个奇怪的现象 -- 不管参数怎样传递, 请求发送到 Operator 时总会返回 <code>422 Unprocessable Content</code>。 Apiserver 返回的错误提示非常清晰，就是请求中缺了必须的字段(<code>FieldValueRequired</code>)。</p><p>排查下来发现这些参数都已经传递了的。具体的请求和返回值如下所示(相关信息已脱敏):</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>curl -X POST -H &quot;Content-Type: application/json&quot; https://example.com/apis/paas.bk.tencent.com/v1alpha1/namespaces/bkapp-foo-prod/bkapps -d \`{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结"><span>总结</span></a></h2><p>本文从现网遇到的奇怪问题入手, 展示了排查 k8s apiserver 接口报错的排查思路和具体流程, 并遵循胡适的思想《大胆假设，小心求证》成功解决问题，最后还查到了关于这个问题背后隐藏的鲜为人知的提案。</p>`,5);function A(j,R){const t=a("ExternalLinkIcon");return l(),u("div",null,[r,n("blockquote",null,[n("p",null,[n("a",c,[e("go playground 传送门"),i(t)])])]),v,n("p",null,[e('代码的问题解决了, 只需要将 "Spec AutoscalingSpec '),m,e('" 修改成 "AutoscalingSpec '),p,e('" 即可修复这个错误行为。'),q,e(" 虽然问题修复了，但想必大家都很好奇既然这个 struct tag 无效, 但为什么 k8s 仍然孜孜不倦地使用它？"),b,e(" 一探究竟之下, 发现这其中的故事居然可追溯至 10 年前的"),n("a",g,[e('提案 - proposal: encoding/json: add "inline" struct tag'),i(t)]),e(", 然而至今仍然未被标准库采纳。")]),n("p",null,[e("提案中的语法 "),h,e(" 借鉴于 "),n("a",y,[e("mgo/bson"),i(t)]),e(", 实际上表达的含义是将 Struct 或 Map 的字段以内联的方式嵌套到上级结构体中, 达到实现动态结构体的需求, "),n("a",k,[e("Go Playground 传送门"),i(t)]),e("。"),_,e(" 具体的需求场景即是希望序列化后的 json 可以根据某个字段(例如 type) 拥有不同的数据结构, 例如:")]),f])}const x=o(d,[["render",A],["__file","golang-容易被-k8s-误导的-json-序列化注释.html.vue"]]),O=JSON.parse('{"path":"/posts/2023/09/28/golang-%E5%AE%B9%E6%98%93%E8%A2%AB-k8s-%E8%AF%AF%E5%AF%BC%E7%9A%84-json-%E5%BA%8F%E5%88%97%E5%8C%96%E6%B3%A8%E9%87%8A.html","title":"[Golang] 容易被 k8s 误导的 json:\\",inline\\"","lang":"zh-CN","frontmatter":{"draft":false,"permalinkPattern":"/posts/:year/:month/:day/:slug.html","type":"post","filePathRelative":"_posts/golang/2023-09-28-[Golang] 容易被 k8s 误导的 json 序列化注释.md","date":"2023-09-28T00:00:00.000Z","title":"[Golang] 容易被 k8s 误导的 json:\\",inline\\"","sidebarDepth":1,"category":"golang","tags":["golang"],"description":"背景介绍 最近在开发 K8s Operator 时遇到一个奇怪的现象 -- 不管参数怎样传递, 请求发送到 Operator 时总会返回 422 Unprocessable Content。 Apiserver 返回的错误提示非常清晰，就是请求中缺了必须的字段(FieldValueRequired)。 排查下来发现这些参数都已经传递了的。具体的请求和返...","head":[["meta",{"property":"og:url","content":"https://blog.shabbywu.cn/posts/2023/09/28/golang-%E5%AE%B9%E6%98%93%E8%A2%AB-k8s-%E8%AF%AF%E5%AF%BC%E7%9A%84-json-%E5%BA%8F%E5%88%97%E5%8C%96%E6%B3%A8%E9%87%8A.html"}],["meta",{"property":"og:site_name","content":"个人技术文章分享"}],["meta",{"property":"og:title","content":"[Golang] 容易被 k8s 误导的 json:\\",inline\\""}],["meta",{"property":"og:description","content":"背景介绍 最近在开发 K8s Operator 时遇到一个奇怪的现象 -- 不管参数怎样传递, 请求发送到 Operator 时总会返回 422 Unprocessable Content。 Apiserver 返回的错误提示非常清晰，就是请求中缺了必须的字段(FieldValueRequired)。 排查下来发现这些参数都已经传递了的。具体的请求和返..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-03-20T13:21:38.000Z"}],["meta",{"property":"article:author","content":"shabbywu"}],["meta",{"property":"article:tag","content":"golang"}],["meta",{"property":"article:published_time","content":"2023-09-28T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2026-03-20T13:21:38.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"[Golang] 容易被 k8s 误导的 json:\\\\\\",inline\\\\\\"\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2023-09-28T00:00:00.000Z\\",\\"dateModified\\":\\"2026-03-20T13:21:38.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"shabbywu\\",\\"url\\":\\"https://github.com/shabbywu\\"}]}"],["link",{"rel":"alternate","type":"application/atom+xml","href":"https://blog.shabbywu.cn/atom.xml","title":"个人技术文章分享 Atom Feed"}],["link",{"rel":"alternate","type":"application/json","href":"https://blog.shabbywu.cn/feed.json","title":"个人技术文章分享 JSON Feed"}],["link",{"rel":"alternate","type":"application/rss+xml","href":"https://blog.shabbywu.cn/rss.xml","title":"个人技术文章分享 RSS Feed"}]]},"headers":[{"level":2,"title":"背景介绍","slug":"背景介绍","link":"#背景介绍","children":[]},{"level":2,"title":"问题定位","slug":"问题定位","link":"#问题定位","children":[]},{"level":2,"title":"追根溯源","slug":"追根溯源","link":"#追根溯源","children":[]},{"level":2,"title":"总结","slug":"总结","link":"#总结","children":[]}],"readingTime":{"minutes":6.15,"words":1845},"filePathRelative":"_posts/golang/2023-09-28-golang-容易被-k8s-误导的-json-序列化注释.md","localizedDate":"2023年9月28日","autoDesc":true,"git":{"createdTime":1774012898000,"updatedTime":1774012898000,"contributors":[{"name":"shabbywu","email":"shabbywu@qq.com","commits":1}]}}');export{x as comp,O as data};
