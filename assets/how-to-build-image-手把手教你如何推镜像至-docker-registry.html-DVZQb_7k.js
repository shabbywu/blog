...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),C={class:"hint-container tip"},j=i("p",{class:"hint-container-title"},"提示",-1),M=i("strong",null,"application/vnd.docker.container.image.v1+json",-1),$=i("code",null,"Config",-1),z=i("code",null,"Image JSON",-1),x=o(`<h3 id="流程总结" tabindex="-1"><a class="header-anchor" href="#流程总结"><span>流程总结</span></a></h3><p><code>Docker Registry</code> 使用 <strong>数字摘要(digest)</strong> 定位镜像层和镜像配置等镜像内容, 而 <code>Docker Image Manifest</code> 又描述了镜像配置和镜像层的数字摘要以及相应的文件类型, 最后 <code>Docker Daemon</code> 只需要根据清单逐一下载解析即可。<br> 简而言之, <code>docker pull</code> 的流程可概况如下:</p><div class="language-plantuml line-numbers-mode" data-ext="plantuml" data-title="plantuml"><pre class="language-plantuml"><code><img src="https://www.plantuml.com/plantuml/svg/V4yrOkj04Ett56Qs-u_12uHRas0DGcCPPcPcPkRaCfwLT8kOmwbsP-PXfHppIR5uD8Bo7_Gxo0V2bAGJuf68pkFn_46_QmkRMXyLvJbTvdv8LzpKKmoMOr9QH_fxONXAcro0zc5oqmc3atyGaYY1yiLqlyb0hxPw1tV3wlOwMHefeE2qBGl1jCv65WvWuGIkp-1m1XPsbFaR61bGvZhAk0gxBiPIN0wvfpoCPs5szDlX82ktPF185yGC9STqcPj-zV6np86kJZYwTJYowSdAghOtKCHbvo8lIWMnhp4jKBfiB1ZgBrFLxlDSahPiaYDup1QX8ZA5Z5LS38jngeN5CUftGnWBsGCNn7IfPfB54KfdKvzdo48lcR-0ZRaF9JW-bkrmjfgzP-wwxEZd4bhdeF9uP0lm78qPJqZcEVkNTGfPl-My3CCtm6ZEB-1o0BeT6ES0
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-上传镜像层与镜像配置至-docker-registry" tabindex="-1"><a class="header-anchor" href="#_2-上传镜像层与镜像配置至-docker-registry"><span>2. 上传镜像层与镜像配置至 Docker Registry</span></a></h3>`,4),S={href:"https://github.com/distribution/distribution/blob/main/docs/spec/api.md#monolithic-upload",target:"_blank",rel:"noopener noreferrer"},Z=o(`<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>## 涉及的环境变量:
...
Hello runc!
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,15);function J(V,W){const d=s("RouteLink"),t=s("ExternalLinkIcon");return u(),b("div",null,[m,i("p",null,[e("正如前言, 当在命令行执行 "),h,e(" 时, 实际上是让 "),p,e(" 往 "),g,e(" 拉取所需的镜像。在笔者上一篇文章"),n(d,{to:"/posts/2021/04/01/how-to-build-image-%E4%BB%8E-0-%E5%BC%80%E5%A7%8B%E5%B8%A6%E4%BD%A0%E5%BE%92%E6%89%8B%E6%9E%84%E5%BB%BA-docker-%E9%95%9C%E5%83%8F.html#%E5%BD%92%E6%A1%A3%E5%B0%81%E5%8C%85"},{default:a(()=>[e("『从 0 开始带你徒手构建 Docker 镜像』")]),_:1}),e("曾经展示过构建镜像的过程, 那么镜像是否就是一个包含了 "),f,e(", "),q,e(", "),k,e(" 的 Tar 归档包呢？")]),i("p",null,[e("答案是否定的, Docker Registry 在分发镜像时是按镜像层为单元进行分发, 而并非直接分发镜像本身。"),y,e(" 但是这又引入了另一个问题, 在笔者的另一篇文章"),n(d,{to:"/posts/2021/01/31/how-to-build-images-docker-%E9%95%9C%E5%83%8F%E8%A7%84%E8%8C%83.html"},{default:a(()=>[e("『Docker 镜像规范 v1.2』")]),_:1}),e("描述的镜像都是基于一定的文件目录结构编排的, 如果需要按镜像层进行分发, 那 "),_,e(" 是如何知道从哪里下载哪个镜像层呢？")]),D,E,I,i("p",null,[e("目前 Docker Registry 共支持两个不同格式的 "),B,e(", 分别为 "),i("a",T,[e("Image Manifest Version 2, Schema 1"),n(t)]),e(" 和 "),i("a",w,[e("Image Manifest Version 2, Schema 2"),n(t)]),e("。")]),A,i("div",C,[j,i("p",null,[e("值得注意的是, "),M,e(" 对应的类型即是在"),n(d,{to:"/posts/2021/01/31/how-to-build-images-docker-%E9%95%9C%E5%83%8F%E8%A7%84%E8%8C%83.html"},{default:a(()=>[e("『Docker 镜像规范 v1.2』")]),_:1}),e("中介绍的 "),$,e("(又被称之为 "),z,e(")。")])]),x,i("p",null,[e("在笔者上一篇文章"),n(d,{to:"/posts/2021/04/01/how-to-build-image-%E4%BB%8E-0-%E5%BC%80%E5%A7%8B%E5%B8%A6%E4%BD%A0%E5%BE%92%E6%89%8B%E6%9E%84%E5%BB%BA-docker-%E9%95%9C%E5%83%8F.html#%E5%BD%92%E6%A1%A3%E5%B0%81%E5%8C%85"},{default:a(()=>[e("『从 0 开始带你徒手构建 Docker 镜像』")]),_:1}),e("曾经构建了一个可运行的镜像, 现在我们尝试将该镜像推送至官方的 Docker Registry -- DockerHub。")]),R,i("p",null,[e("根据"),i("a",S,[e("接口文档"),n(t)]),e(", 我们采用整体上传的方式将镜像层与镜像配置推送至 Docker Registry。")]),Z,i("p",null,[e("这篇文章是『How To Build Images』系列的第三篇，首先介绍了 Docker Daemon 与 Docker Registry 之间的关系, 再详细介绍了 "),O,e(" 与 "),N,e(" 背后隐藏的操作细节, 最后以上一篇文章"),n(d,{to:"/posts/2021/04/01/how-to-build-image-%E4%BB%8E-0-%E5%BC%80%E5%A7%8B%E5%B8%A6%E4%BD%A0%E5%BE%92%E6%89%8B%E6%9E%84%E5%BB%BA-docker-%E9%95%9C%E5%83%8F.html#%E5%BD%92%E6%A1%A3%E5%B0%81%E5%8C%85"},{default:a(()=>[e("『从 0 开始带你徒手构建 Docker 镜像』")]),_:1}),e("曾经构建了一个可运行的镜像为例子, 完整演示了推送镜像至 Dockerhub 的步骤。到目前为止, 我们已经掌握了镜像分发和上传的基本知识, 本系列的下一篇文章将为大家剖析 "),P,e(" 背后被隐藏的细节, 同时也将介绍 Google 提出的一个在容器内构建镜像的方案(kaniko)。")]),H])}const Y=l(v,[["render",J],["__file","how-to-build-image-手把手教你如何推镜像至-docker-registry.html.vue"]]),U=JSON.parse('{"path":"/posts/2021/12/05/how-to-build-image-%E6%89%8B%E6%8A%8A%E6%89%8B%E6%95%99%E4%BD%A0%E5%A6%82%E4%BD%95%E6%8E%A8%E9%95%9C%E5%83%8F%E8%87%B3-docker-registry.html","title":"How To Build Images:手把手教你如何访问 Docker Registry","lang":"zh-CN","frontmatter":{"draft":false,"permalinkPattern":"/posts/:year/:month/:day/:slug.html","type":"post","date":"2021-12-05T00:00:00.000Z","title":"How To Build Images:手把手教你如何访问 Docker Registry","sidebarDepth":2,"category":"容器技术","tags":["docker","build"],"description":"前言 现在是容器化时代，不管是开发、测试还是运维，很少有人会不知道或不会用 Docker。使用 Docker 也很简单，很多时候启动容器无非就是执行 docker run {your-image-name}，而构建镜像也就是执行一句 docker build dockerfile .的事情。 也许正是由于 Docker 对实现细节封装得过于彻底，有时候...","head":[["link",{"rel":"alternate","hreflang":"en-us","href":"https://blog.shabbywu.cn/en/posts/2021/12/05/how-to-build-image-%E6%89%8B%E6%8A%8A%E6%89%8B%E6%95%99%E4%BD%A0%E5%A6%82%E4%BD%95%E6%8E%A8%E9%95%9C%E5%83%8F%E8%87%B3-docker-registry.html"}],["meta",{"property":"og:url","content":"https://blog.shabbywu.cn/posts/2021/12/05/how-to-build-image-%E6%89%8B%E6%8A%8A%E6%89%8B%E6%95%99%E4%BD%A0%E5%A6%82%E4%BD%95%E6%8E%A8%E9%95%9C%E5%83%8F%E8%87%B3-docker-registry.html"}],["meta",{"property":"og:site_name","content":"个人技术文章分享"}],["meta",{"property":"og:title","content":"How To Build Images:手把手教你如何访问 Docker Registry"}],["meta",{"property":"og:description","content":"前言 现在是容器化时代，不管是开发、测试还是运维，很少有人会不知道或不会用 Docker。使用 Docker 也很简单，很多时候启动容器无非就是执行 docker run {your-image-name}，而构建镜像也就是执行一句 docker build dockerfile .的事情。 也许正是由于 Docker 对实现细节封装得过于彻底，有时候..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://blog.shabbywu.cn/img/DockerCS架构.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:locale:alternate","content":"en-US"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:image:alt","content":"How To Build Images:手把手教你如何访问 Docker Registry"}],["meta",{"property":"article:author","content":"shabbywu"}],["meta",{"property":"article:tag","content":"docker"}],["meta",{"property":"article:tag","content":"build"}],["meta",{"property":"article:published_time","content":"2021-12-05T00:00:00.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"How To Build Images:手把手教你如何访问 Docker Registry\\",\\"image\\":[\\"https://blog.shabbywu.cn/img/DockerCS架构.png\\",\\"https://blog.shabbywu.cn/img/Docker-Registry-v2-auth-via-central-service.png\\"],\\"datePublished\\":\\"2021-12-05T00:00:00.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"shabbywu\\",\\"url\\":\\"https://github.com/shabbywu\\"}]}"],["link",{"rel":"alternate","type":"application/atom+xml","href":"https://blog.shabbywu.cn/atom.xml","title":"个人技术文章分享 Atom Feed"}],["link",{"rel":"alternate","type":"application/json","href":"https://blog.shabbywu.cn/feed.json","title":"个人技术文章分享 JSON Feed"}],["link",{"rel":"alternate","type":"application/rss+xml","href":"https://blog.shabbywu.cn/rss.xml","title":"个人技术文章分享 RSS Feed"}]]},"headers":[{"level":2,"title":"前言","slug":"前言","link":"#前言","children":[]},{"level":2,"title":"Docker Daemon 与 Docker Registry 的关系","slug":"docker-daemon-与-docker-registry-的关系","link":"#docker-daemon-与-docker-registry-的关系","children":[]},{"level":2,"title":"Docker Daemon 拉取镜像的流程","slug":"docker-daemon-拉取镜像的流程","link":"#docker-daemon-拉取镜像的流程","children":[{"level":3,"title":"Docker Image Manifest","slug":"docker-image-manifest","link":"#docker-image-manifest","children":[]},{"level":3,"title":"流程总结","slug":"流程总结","link":"#流程总结","children":[]}]},{"level":2,"title":"Docker Daemon 推送镜像的流程","slug":"docker-daemon-推送镜像的流程","link":"#docker-daemon-推送镜像的流程","children":[]},{"level":2,"title":"流程之外但必不可少的步骤: 用户认证","slug":"流程之外但必不可少的步骤-用户认证","link":"#流程之外但必不可少的步骤-用户认证","children":[]},{"level":2,"title":"小试牛刀","slug":"小试牛刀","link":"#小试牛刀","children":[{"level":3,"title":"1. 创建镜像清单(Docker Image Manifest)","slug":"_1-创建镜像清单-docker-image-manifest","link":"#_1-创建镜像清单-docker-image-manifest","children":[]},{"level":3,"title":"2. 上传镜像层与镜像配置至 Docker Registry","slug":"_2-上传镜像层与镜像配置至-docker-registry","link":"#_2-上传镜像层与镜像配置至-docker-registry","children":[]},{"level":3,"title":"3. 上传镜像清单","slug":"_3-上传镜像清单","link":"#_3-上传镜像清单","children":[]},{"level":3,"title":"4. 验证","slug":"_4-验证","link":"#_4-验证","children":[]}]},{"level":2,"title":"总结","slug":"总结","link":"#总结","children":[]},{"level":2,"title":"附录","slug":"附录","link":"#附录","children":[{"level":3,"title":"手把手教你从 Docker Registry 拉取镜像","slug":"手把手教你从-docker-registry-拉取镜像","link":"#手把手教你从-docker-registry-拉取镜像","children":[]}]}],"readingTime":{"minutes":10.96,"words":3289},"filePathRelative":"_posts/container/2021-12-05-how-to-build-image-手把手教你如何推镜像至-docker-registry.md","localizedDate":"2021年12月5日","autoDesc":true}');export{Y as comp,U as data};
