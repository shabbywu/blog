import{_ as t,r as l,o as r,c,b as i,d as e,e as s,w as a,a as d}from"./app-B5jANzC-.js";const v="/img/Git文件状态.png",u={},o=i("h2",{id:"前言",tabindex:"-1"},[i("a",{class:"header-anchor",href:"#前言"},[i("span",null,"前言")])],-1),m=d(`<h2 id="为什么会发生代码冲突" tabindex="-1"><a class="header-anchor" href="#为什么会发生代码冲突"><span>为什么会发生代码冲突？</span></a></h2><p>当多个开发者试图编辑相同的内容时, 那么就可能发送代码冲突。例如以下就是典型的代码冲突时的场景:</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code>## 一开始, 我们实现了一个很简单的 a + b 的函数
def add(a, b):
    try:
        return 0, a + b
    except Exception:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>遇到这种情况的代码冲突, 如果不仔细阅读代码将会造成错误的合并结果。</p><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结"><span>总结</span></a></h2><p>代码冲突在所难免, 在了解冲突发生的原因后精准修复代码是程序员的必备技能之一。通常情况下, Git 已经通过自动合并算法解决了大多数无歧义的代码合并。基本上只有在两个开发者分别修改 1 个文件的相同行时, 或者是一个开发者在修改一份被另一个开发者删除的文件时, 才会出现代码冲突。</p>`,44);function f(y,_){const n=l("RouteLink");return r(),c("div",null,[o,i("p",null,[e("在上一篇文章"),s(n,{to:"/posts/2022/05/27/git-merge-method.html"},{default:a(()=>[e("Git 合并代码的不同方式")]),_:1}),e("中介绍了 Merge Commit、Squash Merge、Cherry-pick、Rebase Merge 等合并方法的差异和使用场景, 接下来我们继续讨论与 Git 密不可分的另一个话题 -- 代码合并冲突。")]),m,i("p",null,[e("在上一篇文章"),s(n,{to:"/posts/2022/05/27/git-merge-method.html"},{default:a(()=>[e("Git 合并代码的不同方式")]),_:1}),e("中有提及, "),b,e(" 会将代码提交记录压缩合并为 1个节点, 并追加至当前分支的末尾。使用 "),g,e(" 会产生以下的拓扑结构:")]),p,i("p",null,[e("在上一篇文章"),s(n,{to:"/posts/2022/05/27/git-merge-method.html"},{default:a(()=>[e("Git 合并代码的不同方式")]),_:1}),e("中有提及, "),h,e(" 即变更当前分支的根节点。对于以下的拓扑结构而言:")]),x])}const k=t(u,[["render",f],["__file","git-merge-conflicts.html.vue"]]),M=JSON.parse('{"path":"/posts/2022/06/08/git-merge-conflicts.html","title":"Git Merge Conflicts","lang":"zh-CN","frontmatter":{"draft":false,"permalinkPattern":"/posts/:year/:month/:day/:slug.html","type":"post","date":"2022-06-08T00:00:00.000Z","title":"Git Merge Conflicts","sidebarDepth":2,"category":"基础技术","tags":["git"],"description":"前言 在上一篇文章中介绍了 Merge Commit、Squash Merge、Cherry-pick、Rebase Merge 等合并方法的差异和使用场景, 接下来我们继续讨论与 Git 密不可分的另一个话题 -- 代码合并冲突。 为什么会发生代码冲突？ 当多个开发者试图编辑相同的内容时, 那么就可能发送代码冲突。例如以下就是典型的代码冲突时的场景:...","head":[["meta",{"property":"og:url","content":"https://blog.shabbywu.cn/posts/2022/06/08/git-merge-conflicts.html"}],["meta",{"property":"og:site_name","content":"个人技术文章分享"}],["meta",{"property":"og:title","content":"Git Merge Conflicts"}],["meta",{"property":"og:description","content":"前言 在上一篇文章中介绍了 Merge Commit、Squash Merge、Cherry-pick、Rebase Merge 等合并方法的差异和使用场景, 接下来我们继续讨论与 Git 密不可分的另一个话题 -- 代码合并冲突。 为什么会发生代码冲突？ 当多个开发者试图编辑相同的内容时, 那么就可能发送代码冲突。例如以下就是典型的代码冲突时的场景:..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://blog.shabbywu.cn/img/Git文件状态.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:image:alt","content":"Git Merge Conflicts"}],["meta",{"property":"article:author","content":"shabbywu"}],["meta",{"property":"article:tag","content":"git"}],["meta",{"property":"article:published_time","content":"2022-06-08T00:00:00.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Git Merge Conflicts\\",\\"image\\":[\\"https://blog.shabbywu.cn/img/Git文件状态.png\\"],\\"datePublished\\":\\"2022-06-08T00:00:00.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"shabbywu\\",\\"url\\":\\"https://github.com/shabbywu\\"}]}"],["link",{"rel":"alternate","type":"application/atom+xml","href":"https://blog.shabbywu.cn/atom.xml","title":"个人技术文章分享 Atom Feed"}],["link",{"rel":"alternate","type":"application/json","href":"https://blog.shabbywu.cn/feed.json","title":"个人技术文章分享 JSON Feed"}],["link",{"rel":"alternate","type":"application/rss+xml","href":"https://blog.shabbywu.cn/rss.xml","title":"个人技术文章分享 RSS Feed"}]]},"headers":[{"level":2,"title":"前言","slug":"前言","link":"#前言","children":[]},{"level":2,"title":"为什么会发生代码冲突？","slug":"为什么会发生代码冲突","link":"#为什么会发生代码冲突","children":[]},{"level":2,"title":"理解冲突的含义","slug":"理解冲突的含义","link":"#理解冲突的含义","children":[]},{"level":2,"title":"合并冲突的类型","slug":"合并冲突的类型","link":"#合并冲突的类型","children":[{"level":3,"title":"Git 无法启动合并","slug":"git-无法启动合并","link":"#git-无法启动合并","children":[]},{"level":3,"title":"Git 智能合并失败","slug":"git-智能合并失败","link":"#git-智能合并失败","children":[]}]},{"level":2,"title":"总结","slug":"总结","link":"#总结","children":[]}],"readingTime":{"minutes":8.6,"words":2579},"filePathRelative":"_posts/common/2022-06-08-git-merge-conflicts.md","localizedDate":"2022年6月8日","autoDesc":true}');export{k as comp,M as data};
