import{_ as o,r as a,o as l,c as u,f as n,g as e,i,e as s}from"./app-B8sGi1tR.js";const d={},r=s(`<h2 id="背景介绍" tabindex="-1"><a class="header-anchor" href="#背景介绍"><span>背景介绍</span></a></h2><p>最近在开发 K8s Operator 时遇到一个奇怪的现象 -- 不管参数怎样传递, 请求发送到 Operator 时总会返回 <code>422 Unprocessable Content</code>。 Apiserver 返回的错误提示非常清晰，就是请求中缺了必须的字段(<code>FieldValueRequired</code>)。</p><p>排查下来发现这些参数都已经传递了的。具体的请求和返回值如下所示(相关信息已脱敏):</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>curl -X POST -H &quot;Content-Type: application/json&quot; https://example.com/apis/paas.bk.tencent.com/v1alpha1/namespaces/bkapp-foo-prod/bkapps -d \`{
