...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果下层文件系统内需要删除 <code>a/b/c/foo</code> 这个文件, 那么下层文件系统则需要创建一个以 <code>.wh.&lt;filename&gt;</code> 为命名的隐藏文件, 即下层文件系统应当具有以下的文件系统结构:</p>`,8),k=e("div",{class:"language-bash line-numbers-mode","data-ext":"sh","data-title":"sh"},[e("pre",{bash:"",class:"language-bash"},[e("code",null,`❯ tree . -a
.
└── a
    └── b
        └── c
