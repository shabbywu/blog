...
import SocialMedia from "vuepress-theme-hope/blog/components/SocialMedia";
import {
  useArticles,
  useBlogOptions,
  useCategoryMap,
  useTagMap,
  useTimelines,
} from "vuepress-theme-hope/blog/composables/index";

import "vuepress-theme-hope/blog/styles/blogger-info.scss";
import "./blogger.scss"
      ...
      return h(
        ...
        [
          h(
            ...
            [
              bloggerAvatar.value ? h("div", {class: "vp-blogger-header"}, [h("img", {
                  class: [
                    "vp-blogger-avatar",
